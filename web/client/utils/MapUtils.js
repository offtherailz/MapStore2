...
export function convertResolution(sourceCRS, targetCRS, sourceResolution, anchorPoint) {
    ...
    // `point` must stay in sourceProjection's own space: getPointResolution never needs a targetCRS transform,
    // which is what used to fail when targetCRS relied on a datum grid not covering the chosen point (#6265).

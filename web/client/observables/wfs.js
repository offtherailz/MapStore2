...
import { getWFSFilterData, createFeatureFilter } from '../utils/FilterUtils';
...
export const getJSONFeature = (searchUrl, filterObj, options = {}, layer) => {
 ...
 * @return {Observable} a stream that emits the GeoJSON or an error.
 */
export const getJSONFeatureWA = (searchUrl, filterObj, { sortOptions = {}, ...options }, layer = {}) =>

...
const getIds = (combinations, xVal, yVal) => {
    let ids = [
        xVal,
        combinations[0][xVal],
        combinations[0][xVal] + " - " + combinations[0][yVal],
    ];
...
function getData({
    ...
    switch (type) {
        ...
        case "sunburst":
            ...
            let children = [
                xDataKey,
                sunburstData[0][xDataKey],
                sunburstData[0][zDataKey],
            ];
            let ids = getIds(sunburstData, xDataKey, zDataKey);

            for (let i = 1; i < sunburstData.length; i++) {
                if (
                    sunburstData[i][xDataKey] === sunburstData[i - 1][xDataKey]
                ) {
            ...
            for (let i = 0; i < sunburstData.length; i++) {
                if (i !== 0) {
                    if (
                        sunburstData[i][xDataKey] ===
                        sunburstData[i - 1][xDataKey]
                    ) {
